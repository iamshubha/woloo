...
CompleteVendor completeVendorFromJson(String str) => CompleteVendor.fromJson(json.decode(str));
...
class CompleteVendor {
    ...
    factory CompleteVendor.fromJson(Map<String, dynamic> json) => CompleteVendor(
        orderSet: json["order_set"] == null ? null : OrderSet.fromJson(json["order_set"]),
    );
...
class OrderSet {
    ...
    factory OrderSet.fromJson(Map<String, dynamic> json) => OrderSet(
        ...
        customer: json["customer"] == null ? null : OrderSetCustomer.fromJson(json["customer"]),
...
class OrderSetCustomer {
    ...
    factory OrderSetCustomer.fromJson(Map<String, dynamic> json) => OrderSetCustomer(
        id: json["id"],
...
class Order {
    ...
    factory Order.fromJson(Map<String, dynamic> json) => Order(
        ...
        fulfillments: json["fulfillments"] == null ? [] : List<dynamic>.from(json["fulfillments"]!.map((x) => x)),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "fulfillments": fulfillments == null ? [] : List<dynamic>.from(fulfillments!.map((x) => x)),
...
class Variant {
    ...
    factory Variant.fromJson(Map<String, dynamic> json) => Variant(
        ...
        productId: json["product_id"],
        product: json["product"] == null ? null : BillingAddress.fromJson(json["product"]),
        createdAt: json["created_at"] == null ? null : DateTime.parse(json["created_at"]),
        updatedAt: json["updated_at"] == null ? null : DateTime.parse(json["updated_at"]),
        deletedAt: json["deleted_at"],
...
class Option {
    ...
    factory Option.fromJson(Map<String, dynamic> json) => Option(
        ...
        option: json["option"] == null ? null : BillingAddress.fromJson(json["option"]),
        createdAt: json["created_at"] == null ? null : DateTime.parse(json["created_at"]),
        updatedAt: json["updated_at"] == null ? null : DateTime.parse(json["updated_at"]),
        deletedAt: json["deleted_at"],
    );
...
class Payment {
    ...
    final String? paymentCollectionId;
    final BillingAddress? paymentSession;
    final Raw? rawAmount;
    final DateTime? createdAt;
    final DateTime? updatedAt;
    final dynamic deletedAt;
    ...
    factory Payment.fromJson(Map<String, dynamic> json) => Payment(
        ...
        paymentCollectionId: json["payment_collection_id"],
        paymentSession: json["payment_session"] == null ? null : BillingAddress.fromJson(json["payment_session"]),
        rawAmount: json["raw_amount"] == null ? null : Raw.fromJson(json["raw_amount"]),
        createdAt: json["created_at"] == null ? null : DateTime.parse(json["created_at"]),
        updatedAt: json["updated_at"] == null ? null : DateTime.parse(json["updated_at"]),
        deletedAt: json["deleted_at"],
...
class Notes {
    ...
    factory Notes.fromJson(Map<String, dynamic> json) => Notes(
        customer: json["customer"] == null ? null : NotesCustomer.fromJson(json["customer"]),
...
class NotesCustomer {
    ...
    factory NotesCustomer.fromJson(Map<String, dynamic> json) => NotesCustomer(
        ...
        firstName: json["first_name"],
        companyName: json["company_name"],
        accountHolders: json["account_holders"] == null ? [] : List<dynamic>.from(json["account_holders"]!.map((x) => x)),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "first_name": firstName,
        "company_name": companyName,
        "account_holders": accountHolders == null ? [] : List<dynamic>.from(accountHolders!.map((x) => x)),
        "billing_address": billingAddress?.toJson(),
    };
}
