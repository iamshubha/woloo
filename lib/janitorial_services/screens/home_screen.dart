    ...
    return   Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text( ServicesStrings.home,
             style: AppTextStyle.font13w7,
            ),
            Text( ServicesStrings.address,
            ...
            children: [
                 ...
                 children: [
                   Expanded(
                     child: CustomTextFormField(
                      ...
                      controller: controller, validator:  (value) {
        
                               if (value == null || value.isEmpty) { return 'Please enter some text'; } return null;
              ...
              Container(
                ...
                itemBuilder: (context, index) {
                   ...
                   InkWell(
                    onTap: () {
                      Navigator.of(context).push( MaterialPageRoute(builder: (context) => const ServiceDetail()));
                    },
                     child: Container(
                      decoration: BoxDecoration(
                        color: AppColors.white,
